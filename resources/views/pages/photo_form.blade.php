                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input id="text" name="text" type="text" class="form-control" placeholder="Digite o título da sua imagem">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea id="textarea" name="textarea" cols="40" rows="5" class="form-control" placeholder="Digite uma pequena descrição da imagem"></textarea>
                  </div>
